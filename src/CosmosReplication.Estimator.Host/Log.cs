...
public static partial class Log
{
  ...
  [LoggerMessage(LogLevel.Information, "Leader election started in namespace '{PodNamespace}' for pod '{PodName}'")]
  public static partial void LeaderElectionStarted(this ILogger logger, string podNamespace, string podName);
}
